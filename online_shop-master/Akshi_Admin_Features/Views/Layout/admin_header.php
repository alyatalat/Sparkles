    ...
    <div id="sidebar-first">
        ...
        <ul class="menu">
            ...
            <li class="menu-item newsletter">
                <a href="../../../Fatemeh_Features/Newsletter/Views/admin_index.php" class="link"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
            ...
            <li class="menu-item testimonials">
                <a href="../../../Fatemeh_Features/Livechat/Views/admin_index.php" class="link"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span>
            ...
            <li class="menu-item promo">
                <a href="../../Promo/Views/admin_index.php" class="link"><span class="glyphicon glyphicon-credit-card" aria-hidden="true"></span>
                    <span class="admin_list">Promo Card</span></a>

                <div class="mobile_menu">
                    <a href="../../Promo/Views/admin_index.php">Promo Card</a>
                </div>

            </li>
            <li class="menu-item shopping">
                <a href="../../ShoppingCart/Views/admin_index.php" class="link"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>
                    <span class="admin_list">Shopping Cart</span></a>

                <div class="mobile_menu">
                    <a href="../../ShoppingCart/Views/admin_index.php">Shopping Cart</a>
                </div>

            </li>
            <li class="menu-item giftcard selectedItem">
                <a href="../../Giftcard/Views/Index.php" class="link"><span class="glyphicon glyphicon-gift" aria-hidden="true"></span>
                    <span class="admin_list">Giftcard</span></a>

                <div class="mobile_menu">
                    <a href="../../Giftcard/Views/Index.php">Giftcard</a>
                </div>
