...
if(empty($_POST['question'])){
    ?>
    <script><?php echo("location.href = '"."../Views/edit_faq_question.php?faq_id=".$faqid . "&err_msg1=Question field cannot be blank"."';");?></script>
...
elseif(empty($_POST['answer'])){
    ?>
    <script><?php echo("location.href = '"."../Views/edit_faq_question.php?faq_id=".$faqid . "&err_msg2=Answer field cannot be blank&tempQuestion=". $_POST['question'] ."';");?></script>
...
?>
        <script><?php echo("location.href = '../Views/edit_faq_category.php?faq_id=" . $_POST['category_id'] . "';");?></script>
