...
<head>
    ...
    <script src="../Views/Layout/Scripts/confirmbox.js"></script>
    ...
    <link rel="stylesheet" href="../Views/Layout/Style/main.css" />
...
<div id="page-container">
    ...
    <div id="sidebar-first">
        ...
        <ul class="menu">
            <li class="menu-item products selectedItem" id="first-item">
