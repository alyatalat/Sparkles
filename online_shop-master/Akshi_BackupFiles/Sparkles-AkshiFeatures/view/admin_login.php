...
<head>
	...
	<link rel="stylesheet" href="../view/admin_login.css" />
...
<body>
	...
	<div id="header" >
		<div class="logo">
			<a href=""><img src="../view/white_logo.png" alt="logo image" /></a>
		</div>
	...
	<form id="login-form" name="login-form" method="post" action="admin.php">
